...
<title>Reports — RAB CONSULTING</title>
...
<section class="section">
  <div class="container portal-shell">
    ...
    <main class="content-stack">
      <div class="panel" style="padding:24px;"><div class="badge">Reports</div><h2>Draft review, approval and PDF export monitoring.</h2></div>
      
<div class="metric-row">
  <div class="metric"><strong>8</strong><span>Drafts awaiting review</span></div><div class="metric"><strong>4</strong><span>Rejected drafts</span></div>
  <div class="metric"><strong>16</strong><span>Approved reports</span></div><div class="metric"><strong>16</strong><span>PDF exports</span></div>
</div>
<div class="table-card"><table><thead><tr><th>Assessment</th><th>Family</th><th>Status</th><th>Reviewer</th><th>Export</th></tr></thead>
<tbody><tr><td>Atlas ERP Recovery</td><td>Full PHI</td><td>Under review</td><td>Reviewer A</td><td>Pending</td></tr>
<tr><td>NorthOps Service Health</td><td>Full ITSM-HI</td><td>Approved</td><td>Reviewer B</td><td><a href="#">PDF ready</a></td></tr>
<tr><td>Nova Retail Wave 2</td><td>Full PHI</td><td>Issued</td><td>Reviewer A</td><td><a href="#">PDF exported</a></td></tr></tbody></table></div>
<div class="panel" style="padding:24px;"><h3>Final report output</h3><p>Export template includes overall score, RAG, indices, executive summary, pillar findings, top risks and 0–90 day roadmap.</p></div>
