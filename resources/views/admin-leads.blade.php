...
<title>Leads — RAB CONSULTING</title>
...
<section class="section">
  <div class="container portal-shell">
    ...
    <main class="content-stack">
      <div class="panel" style="padding:24px;"><div class="badge">Leads</div><h2>Lead triage, tagging, scoring review and conversion workspace.</h2></div>
      
<div class="filter-bar" style="padding:18px;"><div class="toolbar"><div class="actions"><span class="tab active">All</span><span class="tab">PHI</span><span class="tab">ITSM</span><span class="tab">High Priority</span></div><div class="actions"><button class="btn ghost">Export CSV</button><button class="btn secondary">Create client</button></div></div></div>
<div class="table-card"><table><thead><tr><th>Company</th><th>Subject</th><th>Assessment</th><th>Score</th><th>RAG</th><th>Action</th></tr></thead>
<tbody>
<tr><td>Atlas Manufacturing</td><td>Atlas ERP Programme</td><td>Programme Health Check</td><td>2.6</td><td class="rag-amber">Amber</td><td><a href="/assessment-phi-detail">Open</a></td></tr>
<tr><td>NorthOps</td><td>Service Desk</td><td>Service Health Check</td><td>2.3</td><td class="rag-red">Red</td><td><a href="/assessment-itsm-detail">Open</a></td></tr>
<tr><td>Delta Retail</td><td>Rollout Wave 2</td><td>Programme Health Check</td><td>4.0</td><td class="rag-green">Green</td><td><a href="/quote-request">Convert</a></td></tr>
</tbody></table></div>
