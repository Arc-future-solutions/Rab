...
<section class="section">
  <div class="container portal-shell">
    ...
    <main class="content-stack">
      <div class="panel" style="padding:24px;"><div class="badge">Dashboard</div><h2>Unified dashboard for leads, assessments, reports and AI-assisted operations.</h2></div>
      
<div class="metric-row">
  <div class="metric"><strong>128</strong><span>Open leads</span></div>
  <div class="metric"><strong>34</strong><span>Assessments in progress</span></div>
  <div class="metric"><strong>12</strong><span>Reports under review</span></div>
  <div class="metric"><strong>46</strong><span>PDF exports issued</span></div>
</div>
<div class="dashboard-grid" style="grid-template-columns:1.1fr .9fr;display:grid;gap:18px;">
  <div class="table-card"><div class="toolbar" style="padding:18px 18px 0;"><h3>Lead pipeline</h3><div class="actions"><span class="badge">Filtered by status</span></div></div>
    <table><thead><tr><th>Lead</th><th>Assessment</th><th>Score</th><th>RAG</th><th>Priority</th></tr></thead>
    <tbody><tr><td>Atlas ERP Programme</td><td>PHI Snapshot</td><td>2.6</td><td class="rag-amber">Amber</td><td>High</td></tr>
    <tr><td>NorthOps Service Desk</td><td>ITSM Snapshot</td><td>2.3</td><td class="rag-red">Red</td><td>High</td></tr>
    <tr><td>Nova Retail Rollout</td><td>PHI Snapshot</td><td>4.0</td><td class="rag-green">Green</td><td>Medium</td></tr></tbody></table>
  </div>
  <div class="panel" style="padding:24px;">
    <h3>Workflow states</h3>
    <ul><li>Lead submitted</li><li>Lead reviewed</li><li>Full assessment created</li><li>Assessment in progress</li><li>AI draft generated</li><li>Under review</li><li>Approved</li><li>Issued</li></ul>
  </div>
</div>
