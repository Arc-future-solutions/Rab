...
<title>AI Prompts — RAB CONSULTING</title>
...
<section class="section">
  <div class="container portal-shell">
    ...
    <main class="content-stack">
      <div class="panel" style="padding:24px;"><div class="badge">AI Prompts</div><h2>Prompt version governance for snapshots and full reports.</h2></div>
      
<div class="grid-3">
  <div class="card"><div class="badge">Snapshot triage</div><h3>PHI snapshot prompt</h3><p>Priority, risk themes, internal summary, next action and follow-up email draft.</p><button class="btn secondary">Set active version</button></div>
  <div class="card"><div class="badge">Snapshot triage</div><h3>ITSM snapshot prompt</h3><p>Service risk themes, lead priority and structured JSON output controls.</p><button class="btn secondary">Set active version</button></div>
  <div class="card"><div class="badge">Full reports</div><h3>Full report prompts</h3><p>Executive summary, overall assessment, pillar findings, top risks and 0–90 day roadmap.</p><button class="btn secondary">Manage versions</button></div>
</div>
<div class="table-card"><table><thead><tr><th>Assessment family</th><th>Prompt type</th><th>Version</th><th>Status</th></tr></thead>
<tbody><tr><td>PHI</td><td>Snapshot triage</td><td>v1.0</td><td>Active</td></tr><tr><td>PHI</td><td>Full report</td><td>v1.1</td><td>Active</td></tr><tr><td>ITSM</td><td>Snapshot triage</td><td>v1.0</td><td>Active</td></tr><tr><td>ITSM</td><td>Full report</td><td>v1.0</td><td>Draft</td></tr></tbody></table></div>
