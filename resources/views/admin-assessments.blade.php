...
<title>Assessments — RAB CONSULTING</title>
...
<section class="section">
  <div class="container portal-shell">
    ...
    <main class="content-stack">
      <div class="panel" style="padding:24px;"><div class="badge">Assessments</div><h2>Assessment launcher and internal assessment family overview.</h2></div>
      
<div class="toolbar"><div class="actions"><a class="btn primary" href="/assessment-phi-detail">Open Full PHI</a><a class="btn secondary" href="/assessment-itsm-detail">Open Full ITSM-HI</a></div><div class="actions"><span class="badge">Config-driven assessment engine</span></div></div>
<div class="grid-3">
  <div class="assessment-card"><h3>Full PHI</h3><p>Evidence-based programme assessment with 9 pillars, BRI, VRI and critical flags.</p><a class="btn secondary" href="/assessment-phi-detail">Open PHI</a></div>
  <div class="assessment-card"><h3>Full ITSM-HI</h3><p>Service maturity assessment with 11 pillars, SSI, SMI and BRI-S views.</p><a class="btn secondary" href="/assessment-itsm-detail">Open ITSM</a></div>
  <div class="assessment-card"><h3>Create from snapshot</h3><p>Pre-populated full assessment from a lead submission, with subject metadata already mapped.</p><a class="btn ghost" href="/admin-leads">Open leads</a></div>
</div>
