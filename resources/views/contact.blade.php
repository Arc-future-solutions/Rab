...
<title>Contact — RAB CONSULTING</title>
...
<div><div class="kicker"><span class="kicker-dot"></span> Contact RAB Consulting</div><h1>Discuss your programme or service health review.</h1><p>Use this front-end contact page to capture executive interest, assessment requests or commercial enquiries for the platform.</p></div>
<div class="showcase"><img src="/assets/images/contact-illustration.svg" alt="Contact"><div class="caption"><strong>Enterprise contact experience</strong><p class="subtle">Designed to feel credible for consulting and assessment sales.</p></div></div>
</div></section>
<section class="section"><div class="container form-card">
...
<div class="full"><label>What do you need?</label><select required><option value="">Select</option><option>Programme Health Check</option><option>Service Health Check</option><option>Full PHI</option><option>Full ITSM-HI</option><option>Rapid Consulting</option></select></div>
<div class="full"><label>Message</label><textarea required placeholder="Describe your project, service context or consultation requirement."></textarea></div>
</div><div class="hero-actions"><button class="btn primary" type="submit">Send request</button></div><div class="notice">Message recorded successfully in this front-end demo.</div></form>
</div></section>
